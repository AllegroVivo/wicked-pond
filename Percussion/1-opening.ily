...
PercussionNumberOne = \relative c {
    ...
    } #-0.5 d'16 e c d \improvisationOn \hide Stem
    \repeat unfold 31 { c4 } |
    R1 \fermata | 
    \clef treble \improvisationOff \undo \hide Stem \bar "||" \key b \major
    r4 \InstrumentChange "Glockenspiel" #-0.5 fs2 \f fs4
    fs'1 |
    R1 * 2 |
    ...
    R1 * 3 |
    r2 \clef percussion \InstrumentChange "Gran Cassa" #-0.5 g'4-> \sfz r |
    R1 |
    r2 r4 g-> |
    R1 * 2 | \clef treble \bar "||" \key b \major
    \InstrumentChange "Crotales" #-0.5
    fs''1 \ff \laissezVibrer |
    R1 * 2 |
    r2 gs |
    fs1 \laissezVibrer
    R1 * 3 | \bar "||" \key d \major
    \InstrumentChange "Glockenspiel" #-0.5
    a!2 \f fs |
    d1 |
    R1 * 4 | \clef percussion
    \InstrumentChange "Mk. Tree" #-0.5 \xNotesOn \stemUp
    ...
    \InstrumentChange "Glock." #-0.5 fs'1 \pp | \stemNeutral
    ...
    R1 * 6 | \clef bass
    \InstrumentChange "Timp." #-0.5 % TODO: Adjust outside staff priority?
